...
public class ServerScreen extends Hud implements Screen, MyInput {
	...
	private void selectOption() {
		...
		case 0:
			...
			RedUtils.hiloServidor.sendAllMessage("serverDisconnected");
	...
	protected void createActors() {
		...
		//Labels
		title = new Label("Servidor", titleStyle);
