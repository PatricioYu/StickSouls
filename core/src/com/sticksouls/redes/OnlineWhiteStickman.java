...
public class OnlineWhiteStickman extends Character {
	...
	public OnlineWhiteStickman(World world, float x, float y, OrthographicCamera camera) {
	...
	public void draw() {
		...
		if(Gdx.input.isButtonPressed(Input.Buttons.LEFT) && !attacking) {
			...
			attacking = true;
			RedUtils.hiloCliente.sendMessage("attack#" + weapon.getDirection() + "#" + RedUtils.player1);
		}
		if(attacking) {
		...
		RedUtils.hiloCliente.sendMessage("movement#" + super.characterBody.getLinearVelocity().x + "#" + super.characterBody.getLinearVelocity().y + "#" + RedUtils.player1);
